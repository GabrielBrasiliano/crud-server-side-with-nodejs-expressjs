...
const redirectUris: any = 'crud-server-side-with-nodejs-expressjs'.split(',').map((item) => {
    return item.trim();
});

const defaultClient: any = new ClientModel({
    id: 'b57f894078fb271de525afb35de509af1f86ea6f',
    secret: '29776ec393c1c61eea3a9abdec89a3cb65d7987d',
    type: 'confidential',
